...
const HeroSection = () => {
  return (
   ...
   <span class="material-symbols-outlined mt-16 group-hover:text-[#333333] relative top-[30%]">
chevron_right
</span>
    </div>
    <div className='flex lg:hidden items-center text-[#333333] gap-6  relative top-[30%]'>
