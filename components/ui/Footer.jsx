...
import {BsInstagram, BsMastodon} from 'react-icons/bs';
    ...
    <Wrapper styles='text-white bg-[#333333] my-8 py-20'>
      ...
      <div className='flex flex-col lg:flex-row gap-16 '>
        ...
        <div className='flex flex-wrap justify-center gap-4 items-center'>
          ...
          <div className='flex flex-col gap-4 items-center'><div className='p-4 border rounded-full insta duration-300 ease-in-out cursor-pointer'><BsInstagram className=' h-6 w-6'/></div><h4>Instagram</h4></div>
          <div className='flex flex-col gap-4 items-center'><div className='p-4 border rounded-full hover:bg-[#00BEFF] duration-200 ease-in-out cursor-pointer'><ImTwitter className=' h-6 w-6'/></div><h4>Twitter</h4></div>
          <div className='flex flex-col gap-4 items-center'><div className='p-4 border rounded-full hover:bg-[#6159ED] duration-200 ease-in-out cursor-pointer'><BsMastodon className=' h-6 w-6'/></div><h4>Mastodon</h4></div>
